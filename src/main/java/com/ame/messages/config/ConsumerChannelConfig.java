package com.ame.messages.config;
...
@Configuration
/**
 * Class used to configure the connection to a Kafka topic
 * 
...
public class ConsumerChannelConfig {
	...
	/**
	 * Variable found in application.properties: url and port of the Kafka server
	*/
	@Value("${spring.kafka.bootstrap-servers}")
	private String bootstrapServers;

	/**
	 * Variable found in application.properties: name of the topic to listen to
	*/
	...
	public Map<String, Object> consumerConfigs() {
		...
		properties.put(ConsumerConfig.GROUP_ID_CONFIG, springIntegrationKafkaTopic);
		return properties;
	}
}
